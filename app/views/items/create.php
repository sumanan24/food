<div class="page-header">
    ...
    <a href="<?= url('items') ?>" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i> Back</a>
</div>
...
<div class="table-card form-card">
    <form method="POST" action="<?= url('items/store') ?>">
        ...
        <button type="submit" class="btn btn-primary w-100 w-sm-auto"><i class="bi bi-check-lg me-1"></i> Save Item</button>
    </form>
</div>
