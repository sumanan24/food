<div class="transaction-page reports-page">
    <div class="list-toolbar">
        <div class="list-toolbar-info">
            <span class="list-toolbar-label"><i class="bi bi-file-earmark-bar-graph me-1"></i> Reports</span>
            <strong class="list-toolbar-value">Choose a period</strong>
            <span class="list-toolbar-meta">View summaries and export PDF</span>
        </div>
    </div>
            ...
            <div class="card report-card report-card-yearly">
                <div class="card-body">
                    ...
                    <form method="GET" action="<?= url('reports/yearly') ?>">
                        ...
                        <button type="submit" class="btn btn-primary w-100 report-yearly-btn">View Report</button>
                    </form>
                </div>
            </div>
        </div>
